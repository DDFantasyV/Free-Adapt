...
MODELS = {
    ...
    "cifar100": "{YOUR_PATH}\\pretrained_model\\standard\\checkpoints\\checkpoint__best.pt",
}
...
def setup_parser():
    ...
    parser.add_argument("--eval_mode", choices=["pgd"], default="pgd")
    parser.add_argument("--grad_align_lambda", default=1.0, type=float, help="Grad align reg strength")
    parser.add_argument("--K", default=5, help="Number of steps for training", type=int)
    parser.add_argument("--ep_decay", default=15, help="Steps to decay the LR", type=int)
    parser.add_argument("--topdir", default="experiments", help="Top directory to save results")
    ...
    parser.add_argument("--multi_step", default=2, type=int)
    parser.add_argument("--alpha", default=2.5, type=float, help="PGD step will be alpha*eps/K")
